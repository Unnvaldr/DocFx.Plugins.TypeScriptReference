...
namespace DocFx.Plugins.TypeScriptReference
{
    ...
    public class TypeScriptReferenceDocumentProcessor : ReferenceDocumentProcessorBase
    {
        #region ReferenceDocumentProcessorBase Members

            protected override string ProcessedDocumentType { get; } = TypeScriptReferenceConstants.Reference;
        ...
        [ImportMany(nameof(TypeScriptReferenceDocumentProcessor))]
        public override IEnumerable<IDocumentBuildStep> BuildSteps { get; set; }

        public override string Name => nameof(TypeScriptReferenceDocumentProcessor);
            ...
            switch (file.Type)
            {
                case DocumentType.Article:
                        ...
                        ".yaml".Equals(Path.GetExtension(file.File), StringComparison.OrdinalIgnoreCase))
                    {
                        ...
                        switch (mime)
                        {
                            case TypeScriptReferenceConstants.ReferenceYamlMime:
