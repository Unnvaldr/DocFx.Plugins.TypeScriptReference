            ...
            IReadOnlyDictionary<string, ApiNames> references)
        {
            CreateMap<ItemViewModel, ApiBuildOutput>()
                ...
                .AfterMap((src, dest) =>
                {
                    ...
                    dest.ModuleName = ModelConverter.ToApiListInDevLangsResolvingApiNames(src.ModuleName, src.ModuleNameInDevLangs, supportedLanguages, references);
            ...
            CreateMap<ReferenceViewModel, ApiBuildOutput>()
                ...
                .ForMember(dest => dest.ReleaseStage, opt => opt.Ignore())
                .ForMember(dest => dest.Deprecated, opt => opt.Ignore())
                ...
                .AfterMap((src, dest) =>
                {
                    ...
                    if (dest.Metadata.TryGetValue("deprecated", out object deprecated))
                    {
                        dest.Deprecated = Mapper.Map<DeprecatedDetailViewModel, ApiDeprecatedBuildOutput>(deprecated as DeprecatedDetailViewModel);
                        dest.Metadata.Remove("deprecated");
                    }
            ...
            CreateMap<DeprecatedDetailViewModel, ApiDeprecatedBuildOutput>()
                .ForMember(dest => dest.Content, opt => opt.Ignore())
                .AfterMap((src, dest) =>
                {
                    dest.Content = ModelConverter.ToApiListInDevLangs(src.Content, src.Contents, supportedLanguages);
