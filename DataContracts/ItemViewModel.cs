...
namespace DocFx.Plugins.TypeScriptReference
{
    ...
    public class ItemViewModel : IOverwriteDocumentViewModel
    {
        ...
        [ExtensibleMember("module" + Constants.PrefixSeparator)]
        [JsonIgnore]
        public SortedList<string, string> ModuleNameInDevLangs { get; set; } = new SortedList<string, string>();
        ...
        /// <summary>
        /// item's release stage
        /// content in different dev langs can be put in this property all together
        /// </summary>
        [YamlMember(Alias = "releaseStage")]
        [JsonProperty("releaseStage")]
        public List<string> ReleaseStage { get; set; }
        ...
        public DeprecatedDetailViewModel Deprecated { get; set; }
        ...
        public CompositeDictionary ExtensionData =>
            CompositeDictionary
                ...
                .Add("module" + Constants.PrefixSeparator, ModuleNameInDevLangs, JTokenConverter.Convert<string>)
